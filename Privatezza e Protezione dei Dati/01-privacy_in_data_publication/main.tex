...
\begin{itemize}
    \item \textbf{Omogeneità degli dei valori di attributi sensibili:} se tutti gli appartenenti ad un gruppo
...
la presenza o l'assenza di un individuo in un dataset.
...
indipendentemente dal fatto che in individuo sia incluso o meno nel dataset.

\chapter{Alcuni esempi di altri problemi di priacy}
