...
Questa operazione viene fatta passando da delle coordinate cartesiane $(x, y)$ a polari $(r, 0)$.
\begin{figure}[ht]
    \centering
...
La codifica dell'iride in uno spazio 2D, rendendo la codifica invariante
